...
> **별먼지 드롭은 Global Loot Modifier 다** (`moddev/lsrelics` · `data/lsrelics/loot_modifiers/stardust.json`)
>
...
>
> | 등급 | 이름에 들어가는 말 | 확률 | 개수 | 개수(566 중) |
> |---|---|---|---|---|
> | 대형 | `treasure` `tresure` `vault` `hoard` `boss` | 100% | 2~4 | 87 |
> | 소형 | `barrel` `supply` `storage` `house` `grave` `kitchen` `garden` `wool` | 25% | 1 | 115 |
> | 중형 | 그 외 | 50% | 1~2 | 364 |
>
...
>
> 실측(각 30회, 상자에 `/loot insert`): 대형 30/30 · 중형 16/30 · 소형 6/30. 기대값과 일치.
