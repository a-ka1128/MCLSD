...
CLASS = {
    ...
    "rows": [
        ...
        ("패시브", "강철의 각오", "방어력 +5 · 방어 강도 +3 · 평타 위협도 ×1.5 · 기세 중첩당 주는 피해 +6%(최대 5중첩, 10초)", ""),
        ("기본", "강철 발", "3초 뿌리내림 — 6칸 도발 2초 · 이동 불가 · 기세를 전부 소모해 받는 피해 −20%~−45% · 끝날 때 반경 5칸 밀어내며 피해", "12초"),
        ("이동", "참격 인계", "대검을 던지고 그 대검을 잡으며 날아간다 · 지나간 자리의 적이 베인다", "9초"),
        ("추가", "불굴", "8칸 도발 4초 · 기세를 전부 소모해 6초간 받는 피해 −10%+5%/중첩(최대 −35%) · 반경 4.5칸 충격(중첩당 피해 증가) · 기세가 없어도 쓸 수 있다", "22초"),
