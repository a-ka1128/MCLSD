...
CLASS = {
    ...
    "epithet": "흩어진 것을 묶는 자", "role": "버프·지휘",
    "relic": "케스토스",
    ...
    "rows": [
        ...
        ("기본", "고양의 선율", "전방 10칸 아군 공격속도 +25% 4초 + 넉백 저항", "10초"),
        ("이동", "엮인 걸음", "전방 위로 도약 · 착지 지점 4칸 내 아군에게 신속II 3초", "8초"),
        ("추가", "결속의 매듭", "지점에 매듭 12초 · 반경 6칸 아군 받는 피해 −15% + 스킬 쿨 초당 −2%", "25초"),
        ("궁극", "만상의 화음", "24칸 내 전 아군 10초간 공격력 +30% · 이동속도 +25% · 디버프 해제 후 3초간 재부여 면역", "90초"),
    ],
}
