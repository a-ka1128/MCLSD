...
def orb(cy):
    ...
    """
    return (pillar(0.60, cy - 1.08, cy - 0.62, U_GOLD, U_GOLD_D)
            + pillar(0.90, cy - 0.62, cy + 0.62, U_GOLD, U_GOLD_D)
            + pillar(0.60, cy + 0.62, cy + 1.08, U_GOLD, U_GOLD_D))
...
BAND_B0, BAND_B1 = 3.8, 5.0        # 아래 금색 마디
BAND_T0, BAND_T1 = 11.0, 12.2      # 위 금색 마디
SHAFT = 0.34                       # 자루 반두께
