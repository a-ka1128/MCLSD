...
def orb(cy):
    ...
    """
    return (pillar(0.76, cy - 1.25, cy - 0.72, U_GOLD, U_GOLD_D)
            + pillar(1.12, cy - 0.72, cy + 0.72, U_GOLD, U_GOLD_D)
            + pillar(0.76, cy + 0.72, cy + 1.25, U_GOLD, U_GOLD_D))
...
#       **구는 안 건드렸다** — 자루가 얇아진 만큼 구가 «상대적으로» 커 보인다.
#       그게 과하면 orb() 의 1.12 부터 내린다.
Y_BOT, Y_TOP = -6.0, 22.0
ORB_B, ORB_T = -4.4, 20.4          # 구의 중심 (양 끝에서 1.6 안쪽)
BAND_B0, BAND_B1 = 3.3, 4.5        # 아래 금색 마디
BAND_T0, BAND_T1 = 11.5, 12.7      # 위 금색 마디
SHAFT = 0.34                       # 자루 반두께
